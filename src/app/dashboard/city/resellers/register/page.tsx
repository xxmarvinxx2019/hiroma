    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400 mt-0.5">
          Register a new reseller under your network
        </p>
      </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div>
              <label className="block text-xs text-gray-400 mb-1.5">
                PIN code <span className="text-[#C9A84C]">*</span>
              </label>
              <input
                value={pinInput}
                onChange={(e) => {
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={
                  ...
                  !location.street.trim() ||
                  !/^\d{4}$/.test(location.zip_code) ||
                  (!location.province_code && provinces.length > 0)
                }
                  ...
                  <div className="bg-[#F0F2F8] rounded-xl px-4 py-3 space-y-2">
                    ...
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="font-medium text-[#0D1B3E]">
                        ₱
                        {Number(
                          successData.package.acquisition_cost,
                        ).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="font-semibold text-[#1a7a4a]">
                        ₱
                        {Number(
                          successData.package.registration_profit,
                        ).toLocaleString()}
                      </span>
                    </div>
