...
const STATUS_STEPS = [
  ...
  { key: 'ready_for_pickup', label: 'Ready for Pickup', icon: '🏪', desc: 'This order is ready for the reseller to pay and pick up.' },
...
export default function OrderDetailPage() {
  ...
  if (error || !order) return (
    <div className="max-w-5xl mx-auto py-12 text-center">
      ...
      <button onClick={() => router.push('/dashboard/city/orders')} className="text-xs text-[#C9A84C] hover:underline">← Go back</button>
    </div>
  )
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <button onClick={() => router.push('/dashboard/city/orders')}
