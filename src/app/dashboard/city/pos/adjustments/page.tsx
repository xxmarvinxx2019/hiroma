...
export default function PosAdjustmentsPage() {
  ...
  return <main className="min-h-full bg-[#f4f6fb] p-4 sm:p-6"><div className="mx-auto max-w-6xl">
    ...
    <div className="mt-5 rounded-xl border border-amber-200 bg-amber-50 p-4 text-xs leading-5 text-amber-900"><b>Safety rule:</b> Member-sale adjustments are locked in this phase because PU, Product Binary commissions, and wallets require a dedicated reversal ledger. Non-member receipts can be adjusted safely without changing member earnings.</div>
