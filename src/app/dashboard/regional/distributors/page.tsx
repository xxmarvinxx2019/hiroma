...
export default function DistributorsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-[#0D1B3E]">My Provincial Distributors</h1>
        <p className="text-sm text-gray-400 mt-0.5">Provincial distributors under your regional coverage</p>
      </div>
