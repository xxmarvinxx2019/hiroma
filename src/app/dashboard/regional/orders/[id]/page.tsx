...
export default function OrderDetailPage() {
  ...
  if (error || !order) return (
    <div className="max-w-5xl mx-auto py-12 text-center">
      ...
      <button onClick={() => router.push('/dashboard/regional/orders')} className="text-xs text-[#C9A84C] hover:underline">← Go back</button>
    </div>
  )
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Header */}
      <div className="mb-6">
        <button onClick={() => router.push('/dashboard/regional/orders')}
