...
export default function RegionalResellersPage() {
  ...
  const fetchResellers = useCallback(() => {
    ...
    fetch(`/api/regional/resellers?${params}`)
      .then(r => r.json())
      .then(d => {
  ...
  return (
    <div className="w-full space-y-5">
      ...
      <div>
        ...
        <p className="text-sm text-gray-400 mt-0.5">All resellers registered under your region</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-[#0D1B3E]/8 overflow-hidden">
        ...
        {/* Column headers */}
        <div className="grid grid-cols-6 px-4 py-2.5 bg-[#f8f9fc]">
        ...
        {loading ? (
          ...
          <div className="px-4 py-12 text-center">
            ...
            <p className="text-gray-400 text-sm">No resellers found in your region</p>
          </div>
        ) : resellers.map(r => (
