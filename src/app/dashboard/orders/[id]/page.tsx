...
export default function OrderDetailPage() {
  ...
  if (error || !order) return (
    <div className="max-w-5xl mx-auto py-12 text-center">
      ...
      <button onClick={() => router.back()} className="text-xs text-[#C9A84C] hover:underline">← Go back</button>
    </div>
  )
          ...
          <div className="bg-white rounded-2xl border border-[#0D1B3E]/8 overflow-hidden">
            <div className="px-5 py-4 border-b border-[#0D1B3E]/8">
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                Last updated {new Date(order.updated_at).toLocaleDateString('en-PH', { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}
              </p>
            </div>
