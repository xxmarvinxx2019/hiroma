          ...
          <div className="w-full max-w-sm overflow-hidden rounded-2xl bg-white shadow-2xl">
            ...
            <div className="space-y-3 px-5 py-4">
              ...
              {securityAction !== 'disable' && <>
                ...
                <div className="relative">
                  <input type={visiblePinField.confirm ? 'text' : 'password'} inputMode="numeric" autoComplete="new-password" maxLength={6} placeholder={securityAction === 'enable' ? 'Confirm your 6-digit PIN' : 'Confirm new 6-digit PIN'} value={securityForm.confirm_pin} onChange={(event) => setSecurityForm({ ...securityForm, confirm_pin: event.target.value.replace(/\D/g, '').slice(0, 6) })} className="w-full rounded-lg border border-[#0D1B3E]/15 bg-[#F0F2F8] px-10 py-2.5 text-center text-sm outline-none focus:border-[#C9A84C]" />
