...
export async function PATCH(req: NextRequest) {
  try {
    ...
    const deposit = await prisma.branchCashDeposit.findUnique({ where: { id }, select: { branch_id: true, status: true, submitted_by: true, confirmed_by: true, deposit_amount: true } })
